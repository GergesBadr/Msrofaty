...
export default function SelectDuration() {
  ...
  return (
    <form
      ...
      className="flex flex-wrap items-center gap-6 border-b-2 pb-4"
    >
      <div>
        ...
        <input
          ...
          className={`rounded-xl border-2 px-4 py-1 focus:outline-offset-8 ${errors.startDate ? "border-red-400" : "border-gray-300"}`}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className={`rounded-xl border-2 px-4 py-1 focus:outline-offset-8 ${errors.endDate ? "border-red-400" : "border-gray-300"}`}
        />
      </div>
      <Button>تأكيد</Button>
    </form>
